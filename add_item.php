<?php
    ...
    $file_name = addslashes($_POST['itemFileName']);   // for new file name

    // To connect database
    require('res/php/db_con.php');

    // To check if the file already exists
    $sql_check = "SELECT count(*) AS count FROM items WHERE name = '$name' or other_name = ' $name' or name = '$other_name' or other_name = '$other_name'";
